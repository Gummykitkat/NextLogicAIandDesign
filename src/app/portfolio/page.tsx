...
export default function Portfolio() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "ai" | "web" | "combined">(
    "all"
  );
  ...
  const caseStudies = [
    {
      ...
      challenge:
        "Seasonal inventory management leading to 15% overstock and frequent stockouts",
      solution: [
      ...
      ethical:
        "Models were audited for geographic bias to ensure fair inventory distribution across urban and rural locations.",
    ...
    },
    {
      ...
      challenge:
        "Inefficient resource allocation creating long wait times and staff burnout",
      solution: [
      ...
      ethical:
        "Model designed with fairness constraints to prevent any patient demographic from experiencing systematically longer wait times.",
    ...
    },
    {
      ...
      client: "Credit Union",
      challenge:
        "Rising fraud cases with high false positive rate in existing system",
      solution: [
      ...
      ethical:
        "Transparent decision explanations for both staff and customers, with human review for all denials.",
    ...
    },
    {
      ...
      ethical:
        "Design incorporated honest pricing with no hidden fees and clear opt-in choices for marketing.",
    ...
    },
    {
      ...
      client: "Law Firm",
      challenge:
        "Outdated website with poor conversion and accessibility issues",
      solution: [
      ...
      ethical:
        "Dark patterns eliminated in favor of clear value propositions and straightforward calls-to-action.",
    ...
    },
    {
      ...
      challenge:
        "Complex user interface causing training issues and low feature adoption",
      solution: [
      ...
      ethical:
        "Design prioritized data minimization and clear purpose specification for all collected information.",
    ...
    },
    {
      ...
      challenge:
        "Generic website experience with low conversion and repeat purchase rates",
      solution: [
      ...
      ethical:
        "Transparent explanation of personalization with easy opt-out options and clear privacy controls.",
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <section className="mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl">
              At Next Logic Design and AI, we measure our success by the
              tangible business outcomes we deliver for our clients. Explore
              our selected case studies that demonstrate our ability to
              transform organizations through ethical AI and compelling web
              design.
            </p>
          </section>
