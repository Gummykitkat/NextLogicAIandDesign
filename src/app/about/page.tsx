  ...
  const competencies = [
    {
      ...
      description: "Proficiency in advanced AI frameworks and web development stacks, with certified expertise in over 12 AI frameworks and 18+ web technologies."
    },
    {
      icon: Code,
      title: "Creative Excellence",
      description: "User-focused designs that enhance digital presence and drive engagement, with proven results in increasing conversion rates and user satisfaction."
    },
    {
      icon: Users,
      title: "Client-Centric Collaboration",
      description: "Co-creation processes that align with client goals and ethical priorities, ensuring solutions that address specific business needs."
    },
    {
      icon: Shield,
      title: "Ethical Leadership",
      description: "Unwavering commitment to responsible AI and web practices that build trust and compliance, with dedicated resources for ethical reviews."
    }
  ];
  ...
  const objectives = [
    {
      ...
      description: "Achieve 25% year-over-year revenue growth through high-impact projects ($1.5M target by 2026)."
    },
    {
      icon: Heart,
      title: "Client Satisfaction",
      description: "Maintain a 95% satisfaction rate across all services, measured via post-project surveys."
    },
    {
      icon: CheckCheck,
      title: "Ethical Deployment",
      description: "Ensure 100% of projects adhere to ethical, compliant, and secure technology standards."
    },
    {
      icon: UserPlus,
      title: "Team Expansion",
      description: "Increase team capacity by 20% annually to meet growing demand for our services."
    },
    {
      icon: Award,
      title: "Thought Leadership",
      description: "Establish Next Logic as a recognized leader in AI and web design within 3 years."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
              <div>
                <h2 className="text-3xl font-bold mb-4">Next Logic Design and AI</h2>
                <p className="text-lg text-gray-300 mb-6">
                  Next Logic Design and AI is a dual-expertise consultancy firm founded by Sarah Kruger and officially 
                  registered as a sole proprietorship in Calgary, Alberta on February 6, 2025. The company uniquely 
                  positions itself at the intersection of artificial intelligence and innovative web design, delivering 
                ...
                <Card className="p-6 bg-gradient-to-r from-pink-500/10 to-purple-500/10 border-purple-500/50 backdrop-blur">
                  <h3 className="text-xl font-bold mb-2 text-pink-400">Our Mission</h3>
                  <p className="text-gray-300">
                    We empower businesses to leverage cutting-edge AI and web solutions that are not only 
                    technologically advanced but also ethically sound. Our commitment to responsible AI and 
                    user-focused web design sets us apart in a rapidly evolving digital landscape.
                  </p>
                </Card>
              </div>
                ...
                <div className="rounded-lg overflow-hidden border-2 border-purple-500/50 shadow-[0_0_15px_rgba(255,0,128,0.3)]">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.src = "https://images.unsplash.com/photo-1581091226033-c6e1f6b68795?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80";
                    }}
                  />
                </div>
              </div>
            ...
            <div className="space-y-8">
              {objectives.map((objective, index) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-purple-400">{objective.title}</h3>
