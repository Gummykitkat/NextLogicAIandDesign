      ...
      <div className="pt-40 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <section className="mb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Phone, title: "Phone", content: "403-909-5123", link: "tel:4039095123" },
              { icon: Mail, title: "Email", content: "info@nextlogicai.com", link: "mailto:info@nextlogicai.com" },
              { icon: MapPin, title: "Location", content: "Calgary"},
              { icon: Calendar, title: "Business Hours", content: "24/7 Our hours are your hours.", link: null }
            ].map((item, index) => (
              <Card 
                key={index}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                <p className="text-lg text-gray-300 mb-6">
                  We believe that great solutions start with deep understanding. Our engagement process is 
                  designed to ensure we fully grasp your needs, constraints, and goals before proposing solutions. 
                  This approach leads to higher success rates, clearer expectations, and stronger long-term partnerships.
                </p>
                  ...
                  {[
                    {
                      ...
                      icon: Users,
                      content: "30 minute discovery call to discuss your business challenges, goals, and vision."
                    },
                    {
                      title: "Needs Assessment",
                      icon: FileText,
                      content: "In-depth evaluation of your requirements, technical readiness, and compliance considerations."
                    },
                    {
                      title: "Proposal & Planning",
                      icon: BarChart,
                      content: "Detailed project proposal with solution design, timeline, and resource allocation."
                    },
                    {
                      title: "Kickoff & Implementation",
                      icon: Check,
                      content: "Project kickoff meeting, detailed implementation planning, and regular progress updates."
                    }
                  ].map((step, index) => (
                    <div key={index} className="flex">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-purple-400 mb-1">{step.title}</h3>
                    ...
                    {[
                      ...
                      <div key={index} className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300 text-sm">{item.timeline}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="email" className="text-gray-300 block text-sm font-medium">Email Address</label>
                        <input 
                          id="email"
                          name="email"
                          type="email"
                      ...
                      <div className="space-y-2">
                        <label htmlFor="company" className="text-gray-300 block text-sm font-medium">Company Name</label>
                        <input 
                          id="company"
                          name="company"
                      ...
                      <div className="space-y-2">
                        <label htmlFor="phone" className="text-gray-300 block text-sm font-medium">Phone Number</label>
                        <input 
                          id="phone"
                          name="phone"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="projectType" className="text-gray-300 block text-sm font-medium">Project Type</label>
                      <select
                        id="projectType"
                        name="projectType"
                      ...
                      >
                        ...
                        <option value="combined">Combined AI & Web Project</option>
              ...
              {[
                {
                  ...
                  answer: "We typically need an understanding of your business goals, current challenges, desired timeline, and budget range. The more specific you can be about your requirements, the more accurate our initial estimate will be."
                },
                {
                  question: "How do you handle confidential data during the assessment phase?",
                  answer: "We sign NDAs before any detailed discussions and handle all client information with strict confidentiality. For data review, we can work with anonymized samples or conduct assessments in your secure environment."
                },
                {
                  question: "What makes your approach different from other consultancies?",
                  answer: "Our dual expertise in both AI and web design, combined with our ethical foundation, allows us to deliver integrated solutions with both technical excellence and user-focused design. We also prioritize measurable business outcomes over technological complexity."
                },
                {
                  question: "How do you ensure the success of projects?",
                  answer: "We define clear success metrics at the start, implement regular check-ins, provide transparent progress reporting, and maintain a buffer in our timelines for unexpected challenges. Our quality assurance process ensures all deliverables meet our high standards."
                },
                {
                  question: "What happens after project completion?",
                  answer: "We provide 30 days of included support after launch and offer various maintenance and support packages to ensure your solution continues to perform optimally. We also conduct post-launch reviews to identify any optimization opportunities."
                },
                {
                  question: "Do you work with clients outside of Canada?",
                  answer: "Yes, we work with clients globally, although our primary focus is on serving businesses in North America. For international clients, we ensure compliance with relevant regional regulations and can accommodate different time zones for meetings."
                }
              ].map((faq, index) => (
                <Card 
                  key={index}
